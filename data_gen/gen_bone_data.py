...
bone_pairs = {
    ...
    'smarthome/xsub': (
        (5, 4), (4, 3), (3, 3), (3, 2), (2, 1), (6, 3), (8, 6), (10, 8), (7, 3), (9, 7), (11, 9), (12, 5), (14, 12), (16, 14),
        (13, 5), (15, 13), (17, 15)
    ),
    'smarthome/xview1': (
        (5, 4), (4, 3), (3, 2), (3, 3), (2, 1), (6, 3), (8, 6), (10, 8), (7, 3), (9, 7), (11, 9), (12, 5), (14, 12), (16, 14),
        (13, 5), (15, 13), (17, 15)
    ),
    'smarthome/xview2': (
        (5, 4), (4, 3), (3, 2), (3, 3), (2, 1), (6, 3), (8, 6), (10, 8), (7, 3), (9, 7), (11, 9), (12, 5), (14, 12), (16, 14),
...
benchmarks = {
    ...
    'kinetics': ('kinetics',),
    'smarthome': ('smarthome/xsub', 'smarthome/xview1','smarthome/xview2')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', choices=['ntu', 'ntu120', 'kinetics','smarthome'], required=True)
        ...
        for part in parts:
            ...
            try:
                ...
                fp_sp = open_memmap(
                    ...
                    dtype='float32',
                    mode='w+',
                    shape=(N, 2, T, V, M))    #smarthome: shape=(N, 2, T, V, M), others: shape=(N, 3, T, V, M)
